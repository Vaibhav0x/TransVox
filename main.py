...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        '''
        self.actionVoice_to_Text.triggered.connect(lambda: self.stackedWidget.setCurrentIndex(1)) 
        self.actionText_to_Voice.triggered.connect(lambda: self.stackedWidget.setCurrentIndex(2))
